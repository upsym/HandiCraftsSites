...
<!-- 	style="background-color: #1d0c20;"  -->
<!-- 	;filter: sepia(100%) hue-rotate(40deg) invert(85%);-webkit-filter: sepia(100%) hue-rotate(40deg) invert(85%); -->
	<div class="top-header" style="opacity: .9; position: fixed;">
		<div class="container">
			<div class="row">
